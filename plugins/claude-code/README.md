...
HYBRD MCP brings your fitness plan, workout history and logger, profile, and wearable connections into one place. HYBRD is the training system of record for your AI assistant. Connect Garmin, WHOOP, COROS, Apple Health, Hevy and other devices once; Claude Code can then read your workout history and benchmarks, follow and edit your training plan, log lifts and runs, and schedule workouts you complete on your watch. As you complete training, HYBRD adapts the weights and paces prescribed in future sessions.
